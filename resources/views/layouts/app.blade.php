                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('events') }}" class="nav-link">
                                <span class="btn-label nav__icon"><svg xmlns="http://www.w3.org/2000/svg" class="bi bi-calendar" viewBox="0 0 16 16">
                                        <path
                        ...
                        <li class="nav-item">
                            <a href="{{ route('groups') }}" class="nav-link">
                                <span class="btn-label nav__icon"><svg xmlns="http://www.w3.org/2000/svg" class="bi bi-people" viewBox="0 0 16 16">
                                        <path
...
@can('database')
                        <li class="nav-item">
                            <a href="{{ route('database') }}" class="nav-link">
                                <span class="btn-label nav__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-archive" viewBox="0 0 16 16">
                                        <path
...
<li class="nav-item">
    <a href="{{ route('roles') }}" class="nav-link">
        <span class="btn-label nav__icon">
            <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-lock"
                viewBox="0 0 16 16">
                <path
